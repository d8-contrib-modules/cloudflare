...
/**
 * @file
 * Contains \Drupal\cloudflare\CloudFlareComposerDependenciesCheckInterface.
 */
...
interface CloudFlareComposerDependenciesCheckInterface {
  const ERROR_MESSAGE = "Missing Composer dependencies for CloudFlare. <br /> From the root of your site install composer dependencies by running `composer require d8-contrib-modules/cloudflarephpsdk \"1.0.0-alpha1\"`";
